...
const INITAL_SPRITE_FRAME_WIDTH = 64;
const INITIAL_SPRITE_FRAME_HEIGHT = 96;
export const SPRITE_SCALE = 4;
export const SPRITE_WIDTH = INITAL_SPRITE_FRAME_WIDTH * SPRITE_SCALE;
export const SPRITE_HEIGHT = INITIAL_SPRITE_FRAME_HEIGHT * SPRITE_SCALE;
